...
{{
  ...
  "bp_systolic": <P1チャンネルの観血測定平均(MAP)またはnull>,
  "bp_mean": <単一血圧チャンネル(NIBP/ART/IBP単独)のMAPまたはnull>,
  "bp_diastolic": <P2チャンネルの観血測定平均(MAP)またはnull>,
  ...
  "fio2": <FiO2またはnull>,
  "set_respiratory_rate": <人工呼吸器の設定呼吸回数[bpm]またはnull>,
  "set_inspiratory_pressure": <人工呼吸器の設定吸気圧[cmH2O、PEEPからの差分]またはnull>,
  "inspiratory_time": <人工呼吸器の吸気時間[sec]またはnull>,
  "peep": <PEEP[cmH2O]またはnull>,
  "trigger_sensitivity": <トリガ感度[cmH2O]またはnull>,
  "inspiratory_flow": <吸気流量[L/min]またはnull>,
...
- "drager_vista300": Dräger Vista 300（患者モニター）+ Dräger Atlan A100（麻酔器）の2画面構成
  特徴: 2台の画面が横に並ぶ。左画面は15.6インチ・上部に「Dräger」ロゴと青いアクセントバー・下部に"Vista 300"の文字。右画面は15.3インチタッチスクリーンの麻酔器・「Atlan」の表示・気道圧やフロー波形・前面に物理フローチューブ。
